...
const HirePart = () => {
  return (
    <div className='bg-section py-[80px]'>
        <Container>
            ...
            <div className='flex justify-center'>
                <div className='font-primary font-medium bg-primary text-offwhite py-[12px] px-[35px] inline-block rounded-[10px] hover:shadow-lg transform transition-transform duration-300 hover:scale-90 text-lg'>
